            ...
            if Mode == 'Mode0': # 校准IMU
                ...
                try:
                    while True:
                        ...
                        pidoutput=float(recv_data[0])
                        print('Pid Output：%s' % pidoutput)
                        pidSetPoint=recv_data[1]
                        ...
                        if pidoutput>0:
                            if pidoutput<10:
                                angle=round(pidoutput,2)
                                if abs(angle-last_angle)>=0.25:
                                    newboat.servoturning(26,62-4*angle)
                                    last_angle=angle
                            else:
                                angle=10
                                if abs(angle-last_angle)>=0.25:
